...
-(void)YHBaseHttpRequestGETFromRequestObject:(YHBaseHttpRequestObject *)obj requestSuccess:(void (^)(NSData * data))successBlock requestField:(void (^)(NSError * error))fieldBlock isCeche:(BOOL)ceche toCechePath:(YHBaseCechePath)path{
    if (ceche) {
        //先读缓存
...
-(void)YHBaseHttpRequestPOSTFromRequestObject:(YHBaseHttpRequestObject *)obj withParamDictionary:(NSDictionary *)paramDic requestSuccess:(void (^)(NSData *))successBlock requestField:(void (^)(NSError *))fieldBlock isCeche:(BOOL)ceche toCechePath:(YHBaseCechePath)path{
    if (ceche) {
        //先读缓存
        NSData * da = [[YHBaseCecheCenter sharedTheSingletion] readCecheFile:obj.requestIdentity fromPath:path];
        if (da==nil) {
...
//=======================private func========================//
-(void)YHBaseHttpRequestGETFromRequestObject:(YHBaseHttpRequestObject *)obj requestSuccess:(void (^)(NSData * data))successBlock requestField:(void (^)(NSError * error))fieldBlock{
    //判断此请求是否正在进行
...
-(void)YHBaseHttpRequestPOSTFromRequestObject:(YHBaseHttpRequestObject *)obj withParamDictionary:(NSDictionary *)paramDic requestSuccess:(void (^)(NSData * data))successBlock requestField:(void (^)(NSError * error))fieldBlock{
    //判断此请求是否正在进行
    for (YHBaseHttpRequestObject * request in _requestArray) {
        if ([obj.requestIdentity isEqualToString:request.requestIdentity]) {
            //取消请求
