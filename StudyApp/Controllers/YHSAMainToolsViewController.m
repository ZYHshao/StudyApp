...
-(void)YHCreatDate{
    ...
    _controllersArray = @[@"YHSAMockExamController",@"",@"",@"",@"",@"YHSAStudyPlanViewController",@"YHSAStudyNoteViewController",@"YHSAExamInfoViewController",@"YHSASystemSettingViewController"];
}
