...
-(void)YHCreatDate{
    ...
    _controllersArray = @[@"YHSAMockExamController",@"YHSAWrongRecordViewController",@"YHSAExamReloadViewController",@"YHSAExamCollectListViewController",@"YHSAAchievementAnalyseViewController",@"YHSAStudyPlanViewController",@"YHSAStudyNoteViewController",@"YHSAExamInfoViewController",@"YHSASystemSettingViewController"];
}
